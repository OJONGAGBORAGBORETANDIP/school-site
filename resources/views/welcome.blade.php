...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <div class="container">
        ...
        <p class="subtitle">Digital platform for seamless academic reporting, progress tracking and parent-teacher communication at El-Nissi Bilingual School</p>
        ...
        <div class="login-form-container" style="max-width:600px;">
            ...
            <div style="text-align: center; padding: 40px; color: rgba(255,255,255,0.8);">
                ...
                <div class="form-row">
                    ...
                    <button class="login-submit" style="width: 100%; margin-top: 24px;" onclick="closeRegisterModal()">
                        Back to Login
                    </button>
                </div>
            </form>
    ...
    <script>
        function openLoginModal() {
            ...
            setTimeout(() => document.querySelector('.login-form-container').style.transform = 'scale(1)', 100);
        }
